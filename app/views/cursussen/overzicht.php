...
<div id="Agenda" class="Subject">
    <div class="page-header">
        ...
        <div class="AgendaItem">
            ...
            <div><a href="">Inschrijven</a> | <a href="#agenda"  onclick="ChangeContent('beginners')">Meer info</a></div>
        </div>
        <div class="AgendaItem">
            ...
            <div><a href="">Inschrijven</a> | <a  href="#agenda"  onclick="ChangeContent('wadtochten')">Meer info</a></div>
        </div>
        <div class="AgendaItem">
        ...
        <div class="AgendaItem">
            ...
            <div><a href="">Inschrijven</a> | <a  href="#agenda"  onclick="ChangeContent('ervaren')">Meer info</a></div>
        </div>
        <div class="AgendaItem">
