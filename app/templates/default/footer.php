...
<div id="footer">
		...
		<div class="top-footer">
			<div class="container">
				<span class="title"><i class="fa fa-pencil"></i> Heeft u zich al ingeschreven voor een cursus? <a href="cursussen"><button class="button">Schrijf je nu in!</button></a></span>
			</div>
		</div>
		<div class="container">
			<div class="col-md-4">
